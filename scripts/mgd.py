...
class MGD(object):
    ...
    def __init__(self):
        ...
        self._liste_Ti = 6*[np.identity(4)] # liste list des tableaux 4*4 np de transformation rigide entre les axes
    ...
    def compute_robot_state(self,Q):
        ...
        for axis in range(0,self._nb_axis):
            ...
            T0i = self.compute_T(Q[0:axis], 0, axis)              # a calculer
...
def main():
    ...
    modele.init() # initialisation du noeud
